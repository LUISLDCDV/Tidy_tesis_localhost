  ...
  <div class="flex gap-2 flex-wrap mb-4 justify-center">
    <button
      ...
      :class="[
        ...
        item.isActive ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700'
      ]"
    >
  ...
  computed: {
    menuItems() {
      ...
      return [
        ...
        {
          icon: '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-type-underline" viewBox="0 0 16 16">  <path d="M5.313 3.136h-1.23V9.54c0 2.105 1.47 3.623 3.917 3.623s3.917-1.518 3.917-3.623V3.136h-1.23v6.323c0 1.49-.978 2.57-2.687 2.57s-2.687-1.08-2.687-2.57zM12.5 15h-9v-1h9z"/></svg>',
          action: () => this.editor.chain().focus().toggleUnderline().run(),
          isActive: this.editor.isActive('underline'),
        },
        // Encabezados
        {
          icon: '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-type-h1" viewBox="0 0 16 16">  <path d="M7.648 13V3H6.3v4.234H1.348V3H0v10h1.348V8.421H6.3V13zM14 13V3h-1.333l-2.381 1.766V6.12L12.6 4.443h.066V13z"/></svg>',
